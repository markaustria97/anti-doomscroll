...
## TL;DR
Symbol.toPrimitive is a modern JavaScript capability that improves expressiveness, interoperability, or platform reach. Focus on what protocol or runtime behavior it participates in, because that is what makes the feature useful beyond the syntax itself.

## Key Concepts
- Symbol.toPrimitive plugs into a language protocol, platform feature, or module system rule.
...
## Related Topics
- Previous: [Symbol.iterator](07-symbol-iterator.md)
- Next: [Symbol.hasInstance](09-symbol-has-instance.md)
