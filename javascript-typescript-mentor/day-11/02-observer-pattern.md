...
## Why It Matters
Teams reach for the Observer pattern when they need code that can grow without spreading conditionals everywhere. Used well, it localizes change and testing. Used badly, it adds layers no one asked for.
...
## Mini Challenge
Name one small feature where Observer pattern would make the code easier to extend or test.

## Mini Challenge Solution
A good solution identifies the changing part, the stable part, and why the pattern keeps them separate.

## Related Topics
- Previous: [Factory pattern](01-factory-pattern.md)
- Next: [Repository pattern](03-repository-pattern.md)
