...
## Why It Matters
Teams reach for the Strategy when they need code that can grow without spreading conditionals everywhere. Used well, it localizes change and testing. Used badly, it adds layers no one asked for.
...
## Mini Challenge
Name one small feature where Strategy would make the code easier to extend or test.

## Mini Challenge Solution
A good solution identifies the changing part, the stable part, and why the pattern keeps them separate.

## Related Topics
- Previous: [Singleton](12-singleton.md)
- Next: [Builder](14-builder.md)
