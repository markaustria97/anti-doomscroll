...
## Why It Matters
Teams reach for the Adapter pattern when they need code that can grow without spreading conditionals everywhere. Used well, it localizes change and testing. Used badly, it adds layers no one asked for.
...
## Mini Challenge
Name one small feature where Adapter pattern would make the code easier to extend or test.

## Mini Challenge Solution
A good solution identifies the changing part, the stable part, and why the pattern keeps them separate.

## Related Topics
- Previous: [Repository pattern](03-repository-pattern.md)
