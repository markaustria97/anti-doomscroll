...
## Key Concepts
- Identifying memory leaks is mostly about reachability: values stay alive while something reachable still references them.
...
## Why It Matters
Memory issues are expensive because they usually show up after a feature already works. Knowing identifying memory leaks helps you keep long-running sessions stable, investigate leaks methodically, and avoid premature fixes that only hide symptoms.
...
## Interview Angle
- **Q:** What is identifying memory leaks?  
  **A:** Give the mental model first, then show a tiny example.
- **Q:** Why would you use identifying memory leaks in production?  
  **A:** Explain the readability, correctness, or maintainability benefit.

## Mini Challenge
Write the smallest example you can that proves you understand identifying memory leaks.

## Mini Challenge Solution
A good solution is short, runnable, and includes the exact output or behavior you expect.

## Related Topics
- Previous: [GC roots](05-gc-roots.md)
- Next: [closure-based leaks](07-closure-based-leaks.md)
